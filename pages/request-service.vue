...
const services = ref([
  {
    ...
    price: { currency: "KSH", amount: 2500, validity: null },
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 3500, validity: null },
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 2800, validity: null },
    buttonText: "Get Started",
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 4000, validity: null },
    buttonText: "Get Started",
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 4500, validity: null },
    buttonText: "Get Started",
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 5000, validity: null },
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 6000, validity: null },
    buttonText: "Get Started",
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 6500, validity: null },
    buttonText: "Revamp Now",
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 3000, validity: null },
    buttonText: "Book Now",
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 7000, validity: null },
  ...
  },
  {
    ...
    price: { currency: "KSH", amount: 8500, validity: null },
  ...
  // Bundled Career Services
  {
    title: "Silver Package",
    slug: "career_silver_package",
    description:
  ...
  {
    title: "Silver Package",
    slug: "corporate_silver_package",
    description:
      "A solid foundation for team development. Includes a 1-day workshop with one expert trainer, covering key business skills. Available onsite or remotely.",
    price: {
      currency: "KSH",
      amount: 50000,
      validity: null,
  ...
  {
    title: "Gold Package",
    slug: "corporate_gold_package",
    description:
      "Comprehensive skills training. Includes a 3-day workshop with two expert trainers, interactive sessions, and customized learning materials.",
    price: {
      currency: "KSH",
      amount: 90000,
      validity: null,
  ...
  {
    title: "Platinum Package",
    slug: "corporate_platinum_package",
    description:
      "The ultimate corporate training experience! A 5-day program with multiple expert trainers, hands-on coaching, industry case studies, and post-training support.",
    price: {
      currency: "KSH",
      amount: 150000,
      validity: null,
  ...
  {
    title: "Silver Package",
    slug: "va_silver_package",
    description:
      "Basic virtual assistance for small tasks. Includes up to 10 hours of support for email management, data entry, and scheduling.",
    price: {
      currency: "KSH",
      amount: 10000,
      validity: null,
  ...
  {
    title: "Gold Package",
    slug: "va_gold_package",
    description:
      "Enhanced support for growing businesses. Includes 20 hours of virtual assistance for administrative tasks, social media management, and document preparation.",
    price: {
      currency: "KSH",
      amount: 18000,
      validity: null,
  ...
  {
    title: "Platinum Package",
    slug: "va_platinum_package",
    description:
      "Full-scale virtual assistance with dedicated support. Includes 40 hours of assistance covering customer service, bookkeeping, research, and executive support.",
    price: {
      currency: "KSH",
      amount: 25000,
      validity: null,
...
const submitForm = async () => {
  requestServiceFormState.value.service = serviceChosen.value.title;
  requestServiceFormState.value.service_description =
    serviceChosen.value.description;

  await submitRequestServicesForm();
};
</script>
