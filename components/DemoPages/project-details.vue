...
<template>
  <div>
    <section
      id="project-1"
      class="gr--whitesmoke inner-page-hero single-project"
    >
      <div class="container">
          ...
          <div class="col-lg-11 col-xl-10">
            <div class="project-description">
              ...
              <div class="project-title">
                <!-- Title -->
                <h2 class="s-52 w-700">
                  Online shopping concept for mobile app templates
                </h2>
                <!-- Project Data -->
                <div class="project-data">
                  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                    ...
                    <div class="col">
                      <p class="p-lg">
                        <a href="#" class="color--theme">www.website.com</a>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="project-priview-img mb-50">
                <img
                  ...
                  src="/assets/images/projects/project-07.jpg"
                  alt="project-preview"
                />
              </div>
              <!-- PROJECT TEXT -->
              <div class="project-txt">
                ...
                <!-- PROJECT IMAGES -->
                <div
                  class="row d-flex align-items-center project-inner-img mt-50"
                >
                  <!-- IMAGE #1 -->
                  <div class="col-md-6">
                ...
                <div class="project-inner-img mt-30">
                  <div class="project-image project-preview r-10">
                    ...
                    <div class="hover-overlay">
                      <img
                        class="img-fluid"
                        src="/assets/images/projects/project-08.jpg"
                        alt="project-preview"
                      />
                      <div class="item-overlay"></div>
                    </div>
                ...
                >
                  ...
                  <img
                    ...
                    src="/assets/images/projects/project-09.jpg"
                    alt="video-preview"
                  />
                </div>
                <!-- END VIDEO PREVIEW -->
              ...
              <div class="col-md-9">
                <div class="banner-6-txt text-center color--white">
                  ...
                  <a
                    ...
                    >Get srarted - it's free</a
                  >
                  <!-- Button Text -->
                  <p class="p-sm btn-txt ico-15 o-85">
                    <span class="flaticon-check"></span> Free for 14 days, no
