                            ...
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"><SharedCounterUp :start="0" :end="89" :duration="2000" /></span>k
                                    </h2>
                                </div>
                                <!-- Text -->
                    ...
                    <div class="col">
                        <div id="sb-1-3" class="animate__animated animate__fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"><SharedCounterUp :start="0" :end="34" :duration="2000" /></span>k
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-block-txt color--grey">
