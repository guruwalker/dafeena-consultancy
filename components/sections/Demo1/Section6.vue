                            ...
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"> <SharedCounterUp :start="0" :end="60" :duration="2000" /> K </span>
                                    </h2>
                                </div>
                                <!-- Text -->
                    ...
                    <div class="col">
                        <div id="sb-1-2" class="wow fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"> <SharedCounterUp :start="0" :end="70" :duration="2000" /> % </span>
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-block-txt color--grey">
                    ...
                    <div class="col">
                        <div id="sb-1-3" class="wow fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"> <SharedCounterUp :start="0" :end="43" :duration="500" /> K </span>
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-block-txt color--grey">
