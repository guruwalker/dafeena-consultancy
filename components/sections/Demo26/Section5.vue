                        ...
                        <div id="sb-5-1" class="animate__animated animate__fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-digit">
                                    <h2 class="s-44 w-700">
                                        <span class="count-element d-flex"><SharedCounterUp :start="0" :end="56" :duration="2000" />k</span>
                                    </h2>
                                </div>
                                <!-- Text -->
                    ...
                    <div class="col">
                        <div id="sb-5-2" class="animate__animated animate__fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-digit">
                                    <h2 class="s-44 w-700">
                                        <span class="count-element d-flex"><SharedCounterUp :start="0" :end="68" :duration="2000" />k</span>
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-txt">
                    ...
                    <div class="col">
                        <div id="sb-5-3" class="animate__animated animate__fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-digit">
                                    <h2 class="s-44 w-700">
                                        <span class="count-element d-flex"><SharedCounterUp :start="0" :end="42" :duration="2000" />/50</span>
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-txt">
