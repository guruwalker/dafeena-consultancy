        ...
        <div class="col-md-10 col-lg-9">
          <div class="section-title mb-70">
            ...
            <p class="s-21 color--grey">
              We research and keep you updated on the latest trends
            </p>
          </div>
        </div>
      </div>
          ...
          <div id="bp-1-1" class="blog-post wow fadeInUp">
            ...
            <div class="blog-post-img mb-35">
              <img
                ...
                src="/assets/images/blog/post-8-img.jpg"
                alt="blog-post-image"
              />
            </div>
            <!-- BLOG POST TEXT -->
            <div class="blog-post-txt">
              ...
              <!-- Post Link -->
              <h6 class="s-20 w-700">
                <NuxtLink tp="/single-post"
                  >Aliqum mullam porta blandit: tempor sapien and
                  gravida</NuxtLink
                >
              </h6>
              <!-- Text -->
        ...
        <div class="col-md-6 col-lg-4">
          <div id="bp-1-2" class="blog-post wow fadeInUp">
            ...
            <div class="blog-post-img mb-35">
              <img
                class="img-fluid r-16"
                src="/assets/images/blog/post-2-img.jpg"
                alt="blog-post-image"
              />
            </div>
            <!-- BLOG POST TEXT -->
        ...
        <div class="col-md-12 col-lg-4">
          <div id="bp-1-3" class="blog-post wow fadeInUp">
            ...
            <div class="blog-post-img mb-35">
              <img
                class="img-fluid r-16"
                src="/assets/images/blog/post-5-img.jpg"
                alt="blog-post-image"
              />
            </div>
            <!-- BLOG POST TEXT -->
            <div class="blog-post-txt">
              ...
              <h6 class="s-20 w-700">
                <NuxtLink tp="/single-post"
                  >Cubilia laoreet augue egestas and Martex magna
                  impedit</NuxtLink
                >
              </h6>
              <!-- Text -->
