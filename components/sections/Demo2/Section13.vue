      ...
      <div class="row justify-content-center">
        <div class="col-md-10 col-lg-9">
          <div class="section-title mb-80">
            <!-- Title -->
            <h2 class="s-50 w-700">Comprehensive Career Branding Services</h2>
            <!-- Text -->
          ...
          <div class="txt-block left-column animate__animated animate__fadeInRight">
            ...
            <div class="cbox-4">
              ...
              <div class="box-title">
                ...
                <h5 class="s-22 w-700">Resume Writing</h5>
              </div>
              <!-- Text -->
              <div class="cbox-4-txt">
                <p>
                    ATS-friendly resumes that showcase your value.
                </p>
              </div>
            </div>
            <!-- END CONTENT BOX #1 -->
            ...
            <div class="cbox-4">
              ...
              <div class="box-title">
                ...
                <h5 class="s-22 w-700">LinkedIn Optimization</h5>
              </div>
              <!-- Text -->
              <div class="cbox-4-txt">
                <p>
                    Grow your digital professional identity.
                </p>
              </div>
            </div>
            <!-- END CONTENT BOX #2 -->
            ...
            <div class="cbox-4">
              ...
              <div class="box-title">
                ...
                <h5 class="s-22 w-700">Cover Letters</h5>
              </div>
              <!-- Text -->
              <div class="cbox-4-txt">
                <p class="mb-0">
                    Tailored cover letters to get you noticed.
                </p>
              </div>
            </div>
            <!-- END CONTENT BOX #3 -->
