        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6">
            <div class="txt-block left-column color--white animate__animated animate__fadeInRight">
              ...
              <!-- Title -->
              <h2 class="s-56 w-700">
                Join Our Team of Creative and Passionate Professionals
              </h2>
              <!-- Text -->
              <p class="p-lg w-400">
                At Dafeena Consultancy, we value creativity, collaboration, and
                a passion for excellence. Be part of a dynamic team shaping the
                future of personal and professional growth.
              </p>
            </div>
          </div>
          <!-- END TEXT BLOCK -->
